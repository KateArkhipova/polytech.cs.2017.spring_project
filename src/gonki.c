...
![ПРимер интерфейса](unicorn.png) 

# Меню:
![ПРимер меню](play_window.png)
...
*  Главная функция проекта.В данной функции подключается библиотека Allegro и различные ее пакеты.Функция отвечает за работу дисплея .
*@author Klimentova Irina - ira23121998@mail.ru \n
    *@author Arkhipova Ekaterina - arkat98@mail.ru
 \fn int main()
## Игру можно рaзделить на несколько частей:
## Объявление переменных и создание объектов с помощью библиотеки Allegro  

## Игровой цикл:
### Отрисовка меню
### Основной игровой цикл
### Отрисовка уровня и количества набранных очков

### Уничтожение созданных объектов библиотеки Allegro
*/
